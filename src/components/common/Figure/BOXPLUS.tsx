    ...
    <SvgWrap>
      <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          strokeWidth="2"
        />
        <path d="M12.334 17H21.667" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M17 21.667V12.333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </SvgWrap>
  );
};
