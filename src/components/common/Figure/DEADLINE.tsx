...
const DEADLINE: React.FC<FigureProps> = ({ fill, stroke }) => {
  return (
    <SvgWrap>
      <svg viewBox="0 0 23 23" fill={fill ?? 'none'} xmlns="http://www.w3.org/2000/svg" width="25" height="25">
        <path d="M5.89697 3.81689V18.8169" strokeLinecap="round" strokeLinejoin="round" stroke={stroke} />
        <path
          stroke={stroke}
