...
const DEADLINE: React.FC<FigureProps> = ({ fill = 'none' }) => {
  return (
    <SvgWrap>
      <svg viewBox="0 0 23 23" fill={fill} xmlns="http://www.w3.org/2000/svg">
        <path d="M5.89697 3.81689V18.8169" strokeLinecap="round" strokeLinejoin="round" />
        <path
