  ...
  return (
    <SvgWrap>
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path d="M3 3.99805H18" strokeLinecap="round" />
        <path d="M8 2H13" strokeLinecap="round" />
        <path d="M10.5 8.5V13.5" strokeLinecap="round" />
        <path d="M13.5 8.5V13.5" strokeLinecap="round" />
        <path d="M7.5 8.5V13.5" strokeLinecap="round" />
      </svg>
    </SvgWrap>
  );
};
